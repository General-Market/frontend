...
/**
 * LeaderboardSkeleton component (vision/BlackRock light theme)
 * Matches exact table structure of vision/LeaderboardTable
 *
        ...
        <Table>
          <TableHeader>
            <TableRow>
              ...
              <TableHead className="hidden md:table-cell">uPnL</TableHead>
